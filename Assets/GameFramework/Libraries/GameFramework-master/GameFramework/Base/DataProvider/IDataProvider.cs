...
namespace GameFramework
{
    ...
    public interface IDataProvider<T>
    {
        ...
        void ReadData(string dataAssetName, bool isBinary = false);
        ...
        void ReadData(string dataAssetName, int priority, bool isBinary = false);
        ...
        void ReadData(string dataAssetName, object userData, bool isBinary = false);
        ...
        /// <param name="priority">加载数据资源的优先级。</param>
        /// <param name="userData">用户自定义数据。</param>
        void ReadData(string dataAssetName, int priority, object userData,bool isBinary=false);
