...
namespace GameFramework.Config
{
    ...
    internal sealed partial class ConfigManager : GameFrameworkModule, IConfigManager
    {
        ...
        {
            m_DataProvider.ReadData(configAssetName, isBinary);
        }
        ...
        {
            m_DataProvider.ReadData(configAssetName, priority, isBinary);
        }
        ...
        {
            m_DataProvider.ReadData(configAssetName, userData, isBinary);
        }
        ...
        {
            m_DataProvider.ReadData(configAssetName, priority, userData, isBinary);
        }
