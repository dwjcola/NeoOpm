...
namespace GameFramework.DataTable
{
    ...
    public abstract class DataTableBase : IDataProvider<DataTableBase>
    {
        ...
        public void ReadData(string dataTableAssetName,bool isBinary=false)
        {
            m_DataProvider.ReadData(dataTableAssetName, isBinary);
        }
        ...
        public void ReadData(string dataTableAssetName, int priority, bool isBinary = false)
        {
            m_DataProvider.ReadData(dataTableAssetName, priority, isBinary);
        }
        ...
        public void ReadData(string dataTableAssetName, object userData, bool isBinary = false)
        {
            m_DataProvider.ReadData(dataTableAssetName, userData, isBinary);
        }
        ...
        /// <param name="priority">加载数据表资源的优先级。</param>
        /// <param name="userData">用户自定义数据。</param>
        public void ReadData(string dataTableAssetName, int priority, object userData, bool isBinary = false)
        {
            m_DataProvider.ReadData(dataTableAssetName, priority, userData, isBinary);
        }
