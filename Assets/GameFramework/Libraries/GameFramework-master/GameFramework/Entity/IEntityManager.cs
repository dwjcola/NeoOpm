...
namespace GameFramework.Entity
{
    ...
    public interface IEntityManager
    {
        ...
        void SetResourceManager(IAddressableResourceManager resourceManager);
        ...
        /// <param name="entityAssetName">实体资源名称。</param>
        /// <param name="entityGroupName">实体组名称。</param>
        void ShowEntitySync(int entityId, string entityAssetName, string entityGroupName, object userData);
        ...
        /// <param name="entityGroupName">实体组名称。</param>
        /// <param name="priority">加载实体资源的优先级。</param>
        void ShowEntitySync(int entityId, string entityAssetName, string entityGroupName, int priority, object userData);
