...
namespace GameFramework.Localization
{
    ...
    internal sealed partial class LocalizationManager : GameFrameworkModule, ILocalizationManager
    {
        ...
        {
            m_DataProvider.ReadData(dictionaryAssetName,isBinary);
        }
        ...
        {
            m_DataProvider.ReadData(dictionaryAssetName, priority,isBinary);
        }
        ...
        {
            m_DataProvider.ReadData(dictionaryAssetName, userData, isBinary);
        }
        ...
        {
            m_DataProvider.ReadData(dictionaryAssetName, priority, userData, isBinary);
        }
