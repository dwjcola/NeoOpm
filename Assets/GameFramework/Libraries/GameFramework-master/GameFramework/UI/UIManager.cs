...
namespace GameFramework.UI
{
    ...
    internal sealed partial class UIManager : GameFrameworkModule, IUIManager
    {
        ...
        private IAddressableResourceManager m_AddressableResourceManager;
        ...
        public UIManager()
        {
            ...
            m_AddressableResourceManager = null;
            m_InstancePool = null;
            m_UIFormHelper = null;
            m_Serial = 0;
            m_IsShutdown = false;
        ...
        public void SetResourceManager(IAddressableResourceManager resourceManager)
        {
            ...
            {
                throw new GameFrameworkException("AddressableResourceManager manager is invalid.");
            }

            m_AddressableResourceManager = resourceManager;
        }
        ...
        public int OpenUIForm(string uiFormAssetName, string uiGroupName, int priority, bool pauseCoveredUIForm, object userData)
        {
            ...
            if (uiFormInstanceObject == null)
            {
                ...
                m_AddressableResourceManager.LoadAsset<GameObject>(uiFormAssetName, m_LoadAssetCallbacks, OpenUIFormInfo.Create(serialId, uiGroup, pauseCoveredUIForm, userData));
            }
            else
            {
        ...
        public void CloseUIForm(IUIForm uiForm, object userData)
        {
            ...
            if ( m_RecycleQueue.Contains(uiForm))
            {
                return;//回收队列中有，说明已经关闭，不要重复关闭了
            }
        ...
        private void LoadAssetSuccessCallback(string uiFormAssetName, object uiFormAsset, float duration, object userData)
        {
            ...
            UIFormInstanceObject uiFormInstanceObject = UIFormInstanceObject.Create(uiFormAssetName, uiFormAsset, m_UIFormHelper.InstantiateUIForm(uiFormAssetName), m_UIFormHelper);
