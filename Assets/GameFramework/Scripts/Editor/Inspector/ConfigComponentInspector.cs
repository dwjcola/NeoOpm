...
namespace UnityGameFramework.Editor
{
    ...
    internal sealed class ConfigComponentInspector : GameFrameworkInspector
    {
        ...
        private SerializedProperty UseDebug = null;
        private SerializedProperty ShowBuildingArea = null;
        ...
        public override void OnInspectorGUI()
        {
            ...
            EditorGUI.BeginDisabledGroup(EditorApplication.isPlayingOrWillChangePlaymode);
            {
                ...
                EditorGUILayout.PropertyField(UseDebug);
                EditorGUILayout.PropertyField(ShowBuildingArea);
