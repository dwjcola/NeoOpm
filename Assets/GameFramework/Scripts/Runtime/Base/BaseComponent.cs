...
namespace UnityGameFramework.Runtime
{
    ...
    public sealed class BaseComponent : GameFrameworkComponent
    {
        ...
        [SerializeField]
        private bool m_EnterEditorMode = false;
        ...
        public bool EnterEditorMode
        {
            get
            {
                return m_EnterEditorMode;
            }
            set
            {
                m_EnterEditorMode = value;
            }
        }
        ...
        private void OnLowMemory()
        {
            ...
            AddressableResourceComponent aas_Component = GameEntry.GetComponent<AddressableResourceComponent>();
            if (aas_Component != null)
            {
                aas_Component.ForceUnloadUnusedAssets(true);
            }
        }
    }
}
