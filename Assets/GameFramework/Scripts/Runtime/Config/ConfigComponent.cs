...
namespace UnityGameFramework.Runtime
{
    ...
    public sealed class ConfigComponent : GameFrameworkComponent
    {
        ...
        [SerializeField]
        public bool ShowBuildingArea = false;
        ...
        private void Start()
        {
            ...
            m_ConfigManager.SetResourceManager(GameFrameworkEntry.GetModule<IAddressableResourceManager>());
        ...
        public void ReadData(string configAssetName, bool isBinary = false)
        {
            m_ConfigManager.ReadData(configAssetName, isBinary);
        }
        ...
        public void ReadData(string configAssetName, int priority,bool isBinary=false)
        {
            m_ConfigManager.ReadData(configAssetName, priority, isBinary);
        }
        ...
        public void ReadData(string configAssetName, object userData, bool isBinary = false)
        {
            m_ConfigManager.ReadData(configAssetName, userData, isBinary);
        }
        ...
        /// <param name="priority">加载全局配置资源的优先级。</param>
        /// <param name="userData">用户自定义数据。</param>
        public void ReadData(string configAssetName, int priority, object userData, bool isBinary = false)
        {
            m_ConfigManager.ReadData(configAssetName, priority, userData, isBinary);
        }
