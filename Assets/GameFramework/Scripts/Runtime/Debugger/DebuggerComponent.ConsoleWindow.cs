                ...
                GUILayout.BeginVertical("box");
                {
                    ...
                    m_LogScrollPosition = GUILayout.BeginScrollView(m_LogScrollPosition);
                    {
                        ...
                        foreach (LogNode logNode in m_LogNodes)
                        {
                            ...
                            if (GUILayout.Toggle(m_SelectedNode == logNode, GetLogString(logNode),style))
                            {
                                selected = true;
                ...
                GUILayout.BeginVertical("box");
                {
                    m_StackScrollPosition = GUILayout.BeginScrollView(m_StackScrollPosition, GUILayout.Height(100f));
                    {
                        if (m_SelectedNode != null)
                        {
                            ...
                            GUILayout.Label(Utility.Text.Format("<color=#{0}{1}{2}{3}><b>{4}</b></color>", color.r.ToString("x2"), color.g.ToString("x2"), color.b.ToString("x2"), color.a.ToString("x2"), m_SelectedNode.LogMessage),style);
                            ...
                            GUILayout.EndHorizontal();
                            GUILayout.Label(m_SelectedNode.StackTrack,style);
                        }
                        GUILayout.EndScrollView();
                    }
                }
