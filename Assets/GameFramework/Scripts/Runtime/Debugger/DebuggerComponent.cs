...
namespace UnityGameFramework.Runtime
{
    ...
    public sealed partial class DebuggerComponent : GameFrameworkComponent
    {
        ...
        /// 默认调试器漂浮框大小。
        /// </summary>
        internal static readonly Rect DefaultIconRect = new Rect(0f, 0f, 0f, 0f);

        /// <summary>
        /// 默认调试器窗口大小。
        /// </summary>
        internal static readonly Rect DefaultWindowRect = new Rect(10f, 10f, Screen.width-30f,Screen.height-30f);
        ...
        public static GUIStyle style = new GUIStyle();//调试窗口log格式
        /// <summary>
        /// 游戏框架组件初始化。
        /// </summary>
        ...
        Vector2 _oldPostion1 = new Vector2();
        Vector2 _oldPostion2 = new Vector2();
        ...
        private void OnGUI()
        {
            ...
            if (Input.touchCount > 1)
            {
                ...
                {
                    if (_oldPostion1.y - Input.GetTouch(0).position.y > 800 && _oldPostion2.y - Input.GetTouch(1).position.y > 800)
                    {
                        m_ShowFullWindow = true;
                    }
                }
            }
            if (Input.GetKeyDown(KeyCode.Escape))//打开
            {
                m_ShowFullWindow = true;
            }
