...
namespace UnityGameFramework.Runtime
{
    ...
    public sealed partial class EntityComponent : GameFrameworkComponent
    {
        ...
        private void Start()
        {
            ...
            m_EntityManager.SetResourceManager(GameFrameworkEntry.GetModule<IAddressableResourceManager>());
        ...
        /// <param name="priority">加载实体资源的优先级。</param>
        /// <param name="userData">用户自定义数据。</param>
        public void ShowEntitySync(int entityId, Type entityLogicType, string entityAssetName, string entityGroupName, int priority, object userData)
        {
            if (entityLogicType == null)
            {
                Log.Error("Entity type is invalid.");
            ...
            m_EntityManager.ShowEntitySync(entityId, entityAssetName, entityGroupName, priority, ShowEntityInfo.Create(entityLogicType, userData));
        }
