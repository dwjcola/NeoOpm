...
namespace UnityGameFramework.Runtime
{
    ...
    public class DefaultLocalizationHelper : LocalizationHelperBase
    {
        ...
        private AddressableResourceComponent aas_Component = null;
        ...
        public override void ReleaseDataAsset(ILocalizationManager localizationManager, object dictionaryAsset)
        {
            ...
            aas_Component.UnloadAsset(dictionaryAsset);
        }

        private void Start()
        {
            aas_Component = GameEntry.GetComponent<AddressableResourceComponent>();
