...
namespace UnityGameFramework.Runtime
{
    ...
    public sealed class LocalizationComponent : GameFrameworkComponent
    {
        ...
        private void Start()
        {
            ...
            m_LocalizationManager.SetResourceManager(GameFrameworkEntry.GetModule<IAddressableResourceManager>());
        ...
        public void ReadData(string dictionaryAssetName,bool isBinary=false)
        {
            m_LocalizationManager.ReadData(dictionaryAssetName, isBinary);
        }
        ...
        public void ReadData(string dictionaryAssetName, int priority, bool isBinary = false)
        {
            m_LocalizationManager.ReadData(dictionaryAssetName, priority, isBinary);
        }
        ...
        public void ReadData(string dictionaryAssetName, object userData, bool isBinary = false)
        {
            m_LocalizationManager.ReadData(dictionaryAssetName, userData, isBinary);
        }
        ...
        /// <param name="priority">加载字典资源的优先级。</param>
        /// <param name="userData">用户自定义数据。</param>
        public void ReadData(string dictionaryAssetName, int priority, object userData, bool isBinary = false)
        {
            m_LocalizationManager.ReadData(dictionaryAssetName, priority, userData, isBinary);
        }
