Shader "Effect/EXMT_SD_UItongyong"
{
    Properties
    {
        //IsUIShader
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            #pragma multi_compile __ _DOUBLEDISSOLVE
            ...
            #pragma multi_compile __ _FRESNEL_ADD 
            #pragma multi_compile __ _FRESNEL_ALPHA 
            ...
            fixed4 frag (v2f i) : SV_Target
            {
                ...
                //是否打开扰动
                #ifdef _NOISE_ON
                    {
                        ...
                        noiseTex = (noiseTex * 2 - 1) * lerp(_NoiseIntensity,i.customData1.w,_ParticleModeTemp02) ;
                        i.uv1.xy += noiseTex;
                        i.uv1.zw += noiseTex;
                        i.uv2.xy += noiseTex;
                        i.uv2.zw += noiseTex;
