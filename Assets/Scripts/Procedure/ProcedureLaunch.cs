...
namespace NeoOPM
{
    public class ProcedureLaunch : ProcedureBase
    {
        ...
        protected override void OnEnter(ProcedureOwner procedureOwner)
        {
            ...
            // 构建信息：发布版本时，把一些数据以 Json 的格式写入 Assets/Resource_MS/Configs/BuildInfo.txt，供游戏逻辑读取。
            ...
            // 默认字典：加载默认字典文件 Assets/Resource_MS/Configs/DefaultDictionary.xml。
            // 此字典文件记录了资源更新前使用的各种语言的字符串，会随 App 一起发布，故不可更新。
            //GameEntry.BuiltinData.InitDefaultDictionary();
            //GameEntry.UI.InstanceCapacity = 2;
            
            //XluaManager.instance.Init();
            //SLGGame.GameEntry.UI.OpenUI("LoadingUIForm", -1);
        ...
        protected override void OnUpdate(ProcedureOwner procedureOwner, float elapseSeconds, float realElapseSeconds)
        {
            ...
            //ChangeState(procedureOwner, GameEntry.Base.EditorResourceMode ? typeof(ProcedureLogin) : typeof(ProcedureCheckVersion));
