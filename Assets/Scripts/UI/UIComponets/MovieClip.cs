...
namespace NeoOPM
{
    ...
    public class MovieClip : MonoBehaviour
    {
        ...
        {
            mat = m;
            if(image!=null)image.material = mat;
        }
        /// <summary>
        /// 从停止的位置播放动画
        /// </summary>
        ...
        void Start()
        {
            ...
            if(image!=null && mat != null)image.material = mat;
        }
        ...
        private void DoUpdate()
        {
            ...
            if (image != null)
            {
                ...
                image.SetNativeSize();
                Vector2 v2 = new Vector2(frames[currentFrameIndex].pivot.x,frames[currentFrameIndex].pivot.y);
                v2.x /= frames[currentFrameIndex].rect.width;
                v2.y /= frames[currentFrameIndex].rect.height;
                image.rectTransform.pivot = v2;
            }
