...
namespace XLua.CSObjectWrap
{
    ...
    public class DGTweeningSequenceWrap 
    {
        ...
        static int _m_SetLink(RealStatePtr L)
        {
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to DG.Tweening.Sequence.SetLink!");
		    ...
		    try {
                ...
                
                {
                    DG.Tweening.Tween _t = (DG.Tweening.Tween)translator.GetObject(L, 2, typeof(DG.Tweening.Tween));
                        ...
                        var gen_ret = gen_to_be_invoked.Append( _t );
                        translator.Push(L, gen_ret);
		    ...
		    try {
                ...
                
                {
                    DG.Tweening.Tween _t = (DG.Tweening.Tween)translator.GetObject(L, 2, typeof(DG.Tweening.Tween));
                        ...
                        var gen_ret = gen_to_be_invoked.Prepend( _t );
                        translator.Push(L, gen_ret);
		    ...
		    try {
                ...
                
                {
                    DG.Tweening.Tween _t = (DG.Tweening.Tween)translator.GetObject(L, 2, typeof(DG.Tweening.Tween));
                        ...
                        var gen_ret = gen_to_be_invoked.Join( _t );
                        translator.Push(L, gen_ret);
		    ...
		    try {
                ...
                
                {
                    ...
                    DG.Tweening.Tween _t = (DG.Tweening.Tween)translator.GetObject(L, 3, typeof(DG.Tweening.Tween));
                        ...
                        var gen_ret = gen_to_be_invoked.Insert( _atPosition, _t );
                        translator.Push(L, gen_ret);
		    ...
		    try {
                ...
                
                {
                    float _interval = (float)LuaAPI.lua_tonumber(L, 2);
                        ...
                        var gen_ret = gen_to_be_invoked.AppendInterval( _interval );
                        translator.Push(L, gen_ret);
		    ...
		    try {
                ...
                
                {
                    float _interval = (float)LuaAPI.lua_tonumber(L, 2);
                        ...
                        var gen_ret = gen_to_be_invoked.PrependInterval( _interval );
                        translator.Push(L, gen_ret);
		    ...
		    try {
                ...
                
                {
                    DG.Tweening.TweenCallback _callback = translator.GetDelegate<DG.Tweening.TweenCallback>(L, 2);
                        ...
                        var gen_ret = gen_to_be_invoked.AppendCallback( _callback );
                        translator.Push(L, gen_ret);
		    ...
		    try {
                ...
                
                {
                    DG.Tweening.TweenCallback _callback = translator.GetDelegate<DG.Tweening.TweenCallback>(L, 2);
                        ...
                        var gen_ret = gen_to_be_invoked.PrependCallback( _callback );
                        translator.Push(L, gen_ret);
		    ...
		    try {
                ...
                
                {
                    ...
                    DG.Tweening.TweenCallback _callback = translator.GetDelegate<DG.Tweening.TweenCallback>(L, 3);
                        ...
                        var gen_ret = gen_to_be_invoked.InsertCallback( _atPosition, _callback );
                        translator.Push(L, gen_ret);
