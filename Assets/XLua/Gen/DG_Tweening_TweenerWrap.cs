...
namespace XLua.CSObjectWrap
{
    ...
    public class DGTweeningTweenerWrap 
    {
        ...
        static int _m_SetLink(RealStatePtr L)
        {
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to DG.Tweening.Tweener.SetLink!");
        ...
        static int _m_From(RealStatePtr L)
        {
		    try {
                ...
                if(gen_param_count == 1) 
                {
                        ...
                        var gen_ret = gen_to_be_invoked.From(  );
                        translator.Push(L, gen_ret);
                ...
                if(gen_param_count == 2&& LuaTypes.LUA_TBOOLEAN == LuaAPI.lua_type(L, 2)) 
                {
                    bool _isRelative = LuaAPI.lua_toboolean(L, 2);
                        ...
                        var gen_ret = gen_to_be_invoked.From( _isRelative );
                        translator.Push(L, gen_ret);
        ...
        static int _m_SetDelay(RealStatePtr L)
        {
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to DG.Tweening.Tweener.SetDelay!");
