...
namespace XLua.CSObjectWrap
{
    ...
    public class UnityEngineCameraWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			...
			Utils.BeginObjectRegister(type, L, translator, 0, 52, 57, 44);
		    ...
		    try {
                ...
                
                {
                    ...
                    float _duration = (float)LuaAPI.lua_tonumber(L, 3);
                        ...
                        var gen_ret = gen_to_be_invoked.DOAspect( _endValue, _duration );
                        translator.Push(L, gen_ret);
		    ...
		    try {
                ...
                
                {
                    ...
                    float _duration = (float)LuaAPI.lua_tonumber(L, 3);
                        ...
                        var gen_ret = gen_to_be_invoked.DOFarClipPlane( _endValue, _duration );
                        translator.Push(L, gen_ret);
		    ...
		    try {
                ...
                
                {
                    ...
                    float _duration = (float)LuaAPI.lua_tonumber(L, 3);
                        ...
                        var gen_ret = gen_to_be_invoked.DOFieldOfView( _endValue, _duration );
                        translator.Push(L, gen_ret);
		    ...
		    try {
                ...
                
                {
                    ...
                    float _duration = (float)LuaAPI.lua_tonumber(L, 3);
                        ...
                        var gen_ret = gen_to_be_invoked.DONearClipPlane( _endValue, _duration );
                        translator.Push(L, gen_ret);
		    ...
		    try {
                ...
                
                {
                    ...
                    float _duration = (float)LuaAPI.lua_tonumber(L, 3);
                        ...
                        var gen_ret = gen_to_be_invoked.DOOrthoSize( _endValue, _duration );
                        translator.Push(L, gen_ret);
		    ...
		    try {
                ...
                
                {
                    ...
                    float _duration = (float)LuaAPI.lua_tonumber(L, 3);
                        ...
                        var gen_ret = gen_to_be_invoked.DOPixelRect( _endValue, _duration );
                        translator.Push(L, gen_ret);
		    ...
		    try {
                ...
                
                {
                    ...
                    float _duration = (float)LuaAPI.lua_tonumber(L, 3);
                        ...
                        var gen_ret = gen_to_be_invoked.DORect( _endValue, _duration );
                        translator.Push(L, gen_ret);
		    ...
		    try {
                ...
                if(gen_param_count == 6&& LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 2)&& LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 3)&& LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 4)&& LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 5)&& LuaTypes.LUA_TBOOLEAN == LuaAPI.lua_type(L, 6)) 
                {
                    ...
                    bool _fadeOut = LuaAPI.lua_toboolean(L, 6);
                        ...
                        var gen_ret = gen_to_be_invoked.DOShakePosition( _duration, _strength, _vibrato, _randomness, _fadeOut );
                        translator.Push(L, gen_ret);
